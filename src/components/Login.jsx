...
import logo from '../assets/Main22.png'
...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        if (username === adminUsername && password === adminPass) {
            localStorage.setItem("login", true); // Save login state
    ...
    return (
        <div>
            <div className="flex flex-1 flex-col justify-center px-6 py-12 lg:px-8 min-h-full">
